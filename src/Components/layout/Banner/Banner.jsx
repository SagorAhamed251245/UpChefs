    ...
    return (
        <div id='backgroundImage' className={` rounded-xl  w-full md:h-[400px] h-[300px]  lg:h-[570px]  `}>
            <div className='flex h-full flex-col items-center  justify-center w-1/2 mx-auto text-center'>
                <p className=' font-Playfair  text-white md:text-4xl text-2xl lg:text-6xl mt-24 font-semibold leading-normal'>We Will Provide <br /> World Number <br /> <span className='text-green-400'>One Chefs</span></p>
